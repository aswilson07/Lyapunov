...
The family of dynamics that obey the ideal scaling constraints~\eqref{Eq:IdeSca} is invariant under time reparametrizations.  Such time-invariance properties provide more flexibility in algorithm design and analysis, as we will see throughout this paper.
